...
const AGENCY_ROLES  = ['Super Admin', 'Admin', 'Manager', 'SMM', 'Meta Ads Manager'];
...
const agencyStaff = (req, res, next) => {
...
module.exports = { protect, adminOnly, managerOrAdmin, agencyStaff, superAdminOnly };
